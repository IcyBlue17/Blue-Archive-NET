      ...
      <SectionCard className="min-w-0">
        ...
        <div className="mt-4 flex flex-col gap-3">
          {loading && !records.length ? (
            ...
            <Text className="text-app-subtle py-6 text-center">{t.noMatches}</Text>
          )}
        </div>
      </SectionCard>
        ...
        {row ? (
          <>
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-xs">
              ...
              {(row.clearStatus ?? 0) > 0 ? <span className="rounded-full bg-app-fill px-2 py-1">{t.clear}</span> : null}
            </div>

            <div className="mt-5">
              <Text className="mb-2 text-sm font-medium">{t.judgeCounts}</Text>
            ...
            <div className="mt-5">
              <Text className="mb-2 text-sm font-medium">{t.laneRates}</Text>
              <div className="border-app-line overflow-hidden rounded-xl border">
                {rateRows.map((item) => (
                  <div key={item.label} className="border-app-line grid grid-cols-[92px_1fr] gap-3 border-b px-3 py-2 text-sm sm:grid-cols-[130px_1fr] last:border-b-0">
                    <div className="text-app-subtle">{item.label}</div>
          ...
          <Text className="text-app-subtle">{t.pickPlay}</Text>
        )}
      </SectionCard>
    </div>
  )
