...
/** Public: enabled OAuth provider ids (e.g. `google`, `github`). Never throws — UI always shows all providers; empty = none configured or request failed. */
...
/** Logged-in: linked OAuth accounts. */
